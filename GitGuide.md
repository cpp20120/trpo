...
Примените изменения с использованием git cherry-pick:
...
Команда `git bisect` используется для поиска коммита, который внес ошибку в проект. Это особенно полезно для отладки.
